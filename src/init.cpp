...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 99123 or testnet: 199123)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 99124 or testnet: 199124)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Roxcoin Wiki for SSL setup instructions)") + "\n" +
