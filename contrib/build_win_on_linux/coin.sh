...
make -f makefile.linux-mingw $MAKEOPTS DEPSDIR=$STAGING roxcoind.exe USE_UPNP=0 DEBUGFLAGS="-frandom-seed=roxcoin" USE_SSE2=1
$HOST-strip *.exe
rm -rf $OUTDIR/daemon
mkdir $OUTDIR/daemon
